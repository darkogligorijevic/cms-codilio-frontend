// lib/settings-context.tsx - Kompletan fajl sa forsiranom svetlom temom
'use client';
...
function applyThemeToDocument(settings: SiteSettings) {
  ...
  // FORCE LIGHT THEME - Remove dark class and set light theme variables
  ...
  // Apply dynamic theme colors if they exist
